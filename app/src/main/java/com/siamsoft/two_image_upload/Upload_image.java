package com.siamsoft.two_image_upload;
...
public class Upload_image extends Fragment {
    ...
    private String UPLOAD_URL = "http://10.0.2.2//LMEM_01/upload2.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imageView2 = (ImageView) rootView.findViewById(R.id.previewImage2);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST2 && resultCode == mActivity.RESULT_OK && data != null && data.getData() != null) {
            ...
            try {
                ...
                bitmap2 = MediaStore.Images.Media.getBitmap(mActivity.getContentResolver(), filePath);
                //Setting the Bitmap to ImageView
